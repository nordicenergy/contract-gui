<template>
  <div>
    <div class="flex flex-col items-center">
      <h1 class="font-lition text-3xl font-bold">Withdraw vesting from chain completed</h1>
    </div>
    <div v-if="lastWithdrawVestInChain" class="mt-6">
      <div class="mt-2">
        <div class="flex items-center">
          <Check size="xxs"></Check>
          <p class="ml-4 text-md font-bold">{{ lastWithdrawVestInChain.tokens }} LIT tokens successfully withdrawn</p>
        </div>
